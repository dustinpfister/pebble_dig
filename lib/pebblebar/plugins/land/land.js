...
exports.placePebble = function (scope, land) {
    ...
    scope.pebble.getAccount(land.accountNum, function (account) {
        ...
        console.log('i want to stock FedLand#: ' + land.id);
        console.log('the amount of pebble to work with: ' + account.wallet);
		
	    var stack = JSON.parse(land.stack3Data);
		//totalPoints = stack.points.length; 
		
		console.log(pebDist.getDistParams(account.wallet, stack.w,stack.h,stack.d));
