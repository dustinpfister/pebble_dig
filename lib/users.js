/*
 *    users.js for Pebble (pebble_dig hack) (https://github.com/dustinpfister/pebble)
 *    copyright 2016 by Dustin Pfister GPL v3
 *
 *    As the name suggests this file is responsible for creation and maintenance of user records.
 *
 *    This is a hacked over version of user.js for pebble_dig!
 *
 */
                        ...
                        pebble.createAccount(req.body.username, function (accountNumber) {
                            ...
                            info.save(function () {
                                ...
                                newUser.save(function () {
                                    ...
                                    // ALERT! pebble_dig hack
                                    // call newuser script for pebblebar!
                                    require('./pebblebar/newuser.js').forNewUser(newUser.username, function(){
