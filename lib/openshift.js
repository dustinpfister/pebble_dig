 ...
 *
 *    Exports and object that can be used to get openshift environment variables, or local alternatives
 *
...
exports.openShiftObj = {
     ...
     *    process.env.OPENSHIFT_NODEJS_IP, however if developing off-line this environment variable may not be there, and 
     *    will result in undefined. In the case of working off-line you should use the string 'localhost', the loop ip '127.0.0.1', of the
